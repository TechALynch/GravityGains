...
import {
  ...
  useWaitForDOMRef,
  useWillUnmount
} from "./chunk-Z5OK2L3V.js";
import {
  contains,
  listen_default,
  ownerDocument
} from "./chunk-2WWATJ2E.js";
import {
  require_prop_types
...
var Spinner = React44.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size,
...
var SplitButton = React45.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
...
var TabPanel = React47.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabContent = React50.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
    ...
    children: (0, import_jsx_runtime57.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime57.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime57.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames40.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React52.forwardRef(({
  ...
  const classes = (0, import_classnames41.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React54.forwardRef((props, ref) => (0, import_jsx_runtime61.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React55.createContext({
...
var ToastHeader = React56.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime63.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames42.default)(bsPrefix, className),
...
var ToastBody = React57.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ToastContainer = React59.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop2 = () => void 0;
var ToggleButton = React60.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React61.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
